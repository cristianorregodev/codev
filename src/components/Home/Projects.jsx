...
export const Projects = async () => {
    ...
    return (
        <section className="container mx-auto px-2 pt-20 lg:px-20">
            ...
            <div className="mt-8 grid gap-4 place-items-center md:grid-cols-2 md:gap-6 lg:grid-cols-3 lg:gap-8">
