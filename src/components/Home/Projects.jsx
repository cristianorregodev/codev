            ...
            <div className="grid md:grid-cols-4 gap-4 mt-6">
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">{sorted[0].excerpt}</p>
                ...
                >
                    ...
                    <div className="p-6">
                        ...
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">{sorted[1].excerpt}</p>
                        <ul className="flex gap-1 flex-wrap text-sm mt-4">
                ...
                >
                    ...
                    <div className="p-6 md:w-1/2">
                        ...
                        <p className="line-clamp-3 mt-4 text-dark-700 dark:text-dark-200">{sorted[2].excerpt}</p>
                        <ul className="flex gap-1 flex-wrap text-sm mt-4">
